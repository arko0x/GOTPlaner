...
let input = document.getElementById("PointA");
let input2 = document.getElementById("PointB");
console.log("Tourist points");
console.log(touristPoints);
autocomplete(input, touristPoints);
autocomplete(input2, touristPoints);